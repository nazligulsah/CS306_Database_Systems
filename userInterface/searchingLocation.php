...
if (isset($_POST['searchLocation'])) 
{
    ...
    $search = $_POST['searchLocation'];
    $sel = mysqli_query($db, "SELECT * FROM location WHERE location_name = '".$search ."'");
    ...
    if (mysqli_num_rows($sel)>0) 
    {
        ...
        while($row = mysqli_fetch_array($sel)) 
        {
            ...
            echo "<tr>";
            echo "<td>City: " . $row['location_name'] . " </td>";
            echo "</tr>";

            echo "<tr>";
            echo "<td>The Location Name: " . $row['user_location'] . " </td>";
            echo "</tr>";
    ...
    {
        echo'<br><br><br><br>Could not find the Location in database!';
    }
