...
?>
<div align="center">
    <b style="font-size: 30;">Account ID</b>
    <br>
<form action="sendaccountdelete.php" method="POST">
    <select name="ids">

        <?php

        $sql_command = "SELECT account_id FROM Account";

        $myresult = mysqli_query($db, $sql_command);

        while($id_rows = mysqli_fetch_assoc($myresult))
        {
            $account_id = $id_rows['account_id'];
    ...
    <button class="delbtn">DELETE ACCOUNT</button>
</div>
</form>
