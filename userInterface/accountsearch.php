...
<div align="center">
    ...
    <b style="font-size: 30;">Enter Account ID</b>
    <br>
    <br>
    
<form action="sendaccountsearch.php" method="POST">
    <input type="select" id="account_id" placeholder="Account ID" name="account_id">
    <br>
    <br>
