...
<div align="center">
    ...
    <b style="font-size: 30;">Enter Message ID</b>
    <br>
    <br>
    
<form action="sendmessagesearch.php" method="POST">
    <input type="select" id="message_id" placeholder="Message ID" name="message_id">
    <br>
    <br>
